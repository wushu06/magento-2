...
class Interceptor extends \Magento\Catalog\Controller\Adminhtml\Product\Builder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Model\ProductFactory $productFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Registry $registry, \Magento\Cms\Model\Wysiwyg\Config $wysiwygConfig, \Magento\Store\Model\StoreFactory $storeFactory = null)
    {
        $this->___init();
        parent::__construct($productFactory, $logger, $registry, $wysiwygConfig, $storeFactory);
    }
